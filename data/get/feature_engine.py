...
#     single_crypto_df['Open'] = prices_df['Open'][crypto_ticker]
#     single_crypto_df['Adj Close'] = prices_df['Adj Close'][crypto_ticker]
#     single_crypto_df['High'] = prices_df['High'][crypto_ticker]
#     single_crypto_df['Low'] = prices_df['Low'][crypto_ticker]
#     single_crypto_df['Volume'] = prices_df['Volume'][crypto_ticker]
#     #1month returns
...
#
#
#     print(single_crypto_df)
#     return single_crypto_df

def create_single_crypto_df(crypto_ticker):
    prices_df = pd.read_csv('yahoo.csv')
    single_crypto_df = pd.DataFrame()
    single_crypto_df['Open'] = prices_df['Open'][crypto_ticker]
    single_crypto_df['Adj Close'] = prices_df['Adj Close'][crypto_ticker]
    single_crypto_df['High'] = prices_df['High'][crypto_ticker]
